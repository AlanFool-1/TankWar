...
class Food(pygame.sprite.Sprite):
	def __init__(self):
		...
		# 所有食物
		self.foods = [self.food_boom, self.food_clock, self.food_gun, self.food_protect, self.food_star, self.food_tank]
		self.kind = None
		self.food = None
		self.rect = None
		# 是否存在
	...
	def generate(self):
		...
		self.rect.left, self.rect.top = random.randint(100, 700), random.randint(100, 700)
		self.being = True
